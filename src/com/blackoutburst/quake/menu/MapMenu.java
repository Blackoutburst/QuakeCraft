...
public class MapMenu {
	...
	public static void open(Player p) {
		...
		setItem(inv, Material.WOOD, (byte) 3, "§6Forgotten", 28);
		setItem(inv, Material.ICE, (byte) 0, "§bFrostmonic", 29);
		setItem(inv, Material.SNOW_BLOCK, (byte) 0, "§6Fryst", 30);
		setItem(inv, Material.LOG, (byte) 3, "§bHaikyo", 31);
		setItem(inv, Material.NETHER_BRICK, (byte) 0, "§bHot War", 32);
		setItem(inv, Material.LOG, (byte) 0, "§6HustWood", 33);
		setItem(inv, Material.LOG, (byte) 0, "§bHustWood Edit", 34);
		setItem(inv, Material.STAINED_CLAY, (byte) 7, "§6Karunesh", 35);
		setItem(inv, Material.BOOKSHELF, (byte) 0, "§bLibrary", 36);
		setItem(inv, Material.QUARTZ_BLOCK, (byte) 1, "§bLobby 1", 37);
		setItem(inv, Material.QUARTZ_BLOCK, (byte) 1, "§bLobby 2", 38);
		setItem(inv, Material.COBBLESTONE, (byte) 0, "§6Lost World", 39);
		setItem(inv, Material.WATER_LILY, (byte) 0, "§bLotus", 40);
		setItem(inv, Material.GOLD_BLOCK, (byte) 0, "§bLunar Lost World", 41);
		setItem(inv, Material.DARK_OAK_DOOR_ITEM, (byte) 0, "§bMansion", 42);
		setItem(inv, Material.STAINED_GLASS, (byte) 5, "§6Martian", 43);
		setItem(inv, Material.STAINED_GLASS, (byte) 5, "§bMartian Flipped", 44);
