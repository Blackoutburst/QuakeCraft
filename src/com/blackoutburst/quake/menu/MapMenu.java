...
public class MapMenu {
	...
	public static void open(Player p) {
		...
		setItem(inv, Material.LEGACY_WOOL, (byte) 14, "§6Apex", 1);
		setItem(inv, Material.LEGACY_WOOL, (byte) 14, "§6Apex II", 2);
		setItem(inv, Material.LEGACY_WOOL, (byte) 14, "§6Apex III", 3);
		setItem(inv, Material.LEGACY_WOOL, (byte) 14, "§bApex IV", 4);
		setItem(inv, Material.LEGACY_WOOL, (byte) 14, "§bApexSH", 5);
		setItem(inv, Material.LEGACY_SMOOTH_BRICK, (byte) 0, "§bArx Citadel", 6);
		setItem(inv, Material.SANDSTONE, (byte) 1, "§6Ascended", 7);
		setItem(inv, Material.LEGACY_ENDER_STONE, (byte) 0, "§6Belmorn", 8);
		setItem(inv, Material.LEGACY_ENDER_STONE, (byte) 0, "§bBelmorn2", 9);
		setItem(inv, Material.LEGACY_LOG, (byte) 1, "§bBlackwood", 10);
		setItem(inv, Material.LEGACY_SMOOTH_BRICK, (byte) 0, "§bBowel", 11);
		setItem(inv, Material.LEGACY_STAINED_CLAY, (byte) 10, "§bCargo", 12);
		...
		setItem(inv, Material.LEGACY_WOOD, (byte) 0, "§bDropper", 21);
		setItem(inv, Material.LEGACY_SMOOTH_BRICK, (byte) 1, "§bDropper II", 22);
		setItem(inv, Material.LEGACY_SMOOTH_BRICK, (byte) 2, "§bDungeon", 23);
		...
		setItem(inv, Material.LEGACY_WOOD, (byte) 3, "§6Forgotten", 27);
		setItem(inv, Material.ICE, (byte) 0, "§bFrostmonic", 28);
		setItem(inv, Material.SNOW_BLOCK, (byte) 0, "§6Fryst", 29);
		setItem(inv, Material.LEGACY_LOG, (byte) 3, "§bHaikyo", 30);
		setItem(inv, Material.NETHER_BRICK, (byte) 0, "§bHot War", 31);
		setItem(inv, Material.LEGACY_LOG, (byte) 0, "§6HustWood", 32);
		setItem(inv, Material.LEGACY_LOG, (byte) 0, "§bHustWood Edit", 33);
		setItem(inv, Material.LEGACY_STAINED_CLAY, (byte) 7, "§6Karunesh", 34);
		...
		setItem(inv, Material.LEGACY_WATER_LILY, (byte) 0, "§bLotus", 39);
		setItem(inv, Material.GOLD_BLOCK, (byte) 0, "§bLunar Lost World", 40);
		setItem(inv, Material.LEGACY_DARK_OAK_DOOR_ITEM, (byte) 0, "§bMansion", 41);
		setItem(inv, Material.LEGACY_STAINED_GLASS, (byte) 5, "§6Martian", 42);
		setItem(inv, Material.LEGACY_STAINED_GLASS, (byte) 5, "§bMartian Flipped", 43);
	...
	public static void open2(Player p) {
		...
		setItem(inv, Material.LEGACY_WOOL, (byte) 14, "§bMega Apex", 0);
		...
		setItem(inv, Material.LEGACY_LOG, (byte) 0, "§bOld HustWood", 5);
		setItem(inv, Material.COBBLESTONE, (byte) 0, "§bOld Lost World", 6);
		setItem(inv, Material.LEGACY_STAINED_GLASS, (byte) 13, "§bOld Martian", 7);
		setItem(inv, Material.IRON_ORE, (byte) 0, "§bOld Mines", 8);
		setItem(inv, Material.LEGACY_WOOD, (byte) 0, "§bOld WoodStone", 9);
		setItem(inv, Material.LEGACY_RED_ROSE, (byte) 1, "§bOrchid", 10);
		setItem(inv, Material.LEGACY_STAINED_CLAY, (byte) 15, "§bQuake City", 11);
		setItem(inv, Material.IRON_BLOCK, (byte) 0, "§bQuakecraft", 12);
		setItem(inv, Material.LEGACY_STAINED_GLASS, (byte) 2, "§6Reactor", 13);
		setItem(inv, Material.LEGACY_SMOOTH_BRICK, (byte) 1, "§bRuin", 14);
		setItem(inv, Material.SAND, (byte) 0, "§bSandstorm", 15);
		setItem(inv, Material.LEGACY_SMOOTH_BRICK, (byte) 3, "§6Sero", 16);
		setItem(inv, Material.LEGACY_SMOOTH_BRICK, (byte) 3, "§bSeroII", 17);
		...
		setItem(inv, Material.LEGACY_STEP, (byte) 4, "§bTown Edit", 22);
		setItem(inv, Material.MINECART, (byte) 0, "§bTrain", 23);
		setItem(inv, Material.LEGACY_WOOL, (byte) 0, "§bWhiteroom", 24);
		setItem(inv, Material.LEGACY_WOOD, (byte) 0, "§6WoodStone", 25);
