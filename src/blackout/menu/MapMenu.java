...
public class MapMenu {
	...
	public static void open(Player p) {
		...
		setItem(inv, Material.BOOKSHELF, (byte) 7, "§bLibrary", 30);
		setItem(inv, Material.QUARTZ_BLOCK, (byte) 1, "§bLobby 1", 31);
		setItem(inv, Material.QUARTZ_BLOCK, (byte) 1, "§bLobby 2", 32);
		setItem(inv, Material.SMOOTH_BRICK, (byte) 2, "§6Lost World", 33);
		setItem(inv, Material.SMOOTH_BRICK, (byte) 2, "§bOld Lost World", 34);
		setItem(inv, Material.DARK_OAK_DOOR_ITEM, (byte) 0, "§bMansion", 35);
		setItem(inv, Material.STAINED_GLASS, (byte) 5, "§6Martian", 36);
		setItem(inv, Material.STAINED_GLASS, (byte) 13, "§bOld Martian", 37);
		setItem(inv, Material.DIAMOND_ORE, (byte) 0, "§6Mines", 38);
		setItem(inv, Material.IRON_ORE, (byte) 0, "§bOld Mines", 39);
		setItem(inv, Material.RED_ROSE, (byte) 1, "§bOrchid", 40);
